...
edges = [(i, i + 1) for i in range(len(yil) - 1)]  # Ardışık yıllar arasında kenarlar oluştur
...
class BigNet(nn.Module):
    def __init__(self):
        ...
        self.conv4 = GCNConv(64, 1)  # 64 input features, 1 output feature
        self.dropout = nn.Dropout(0.2)  # Dropout değerini düşür
