...
{
    public class IkibinyirmiucsecimikiController : Controller
    {

        ikibinyirmiucsecimikiBl secim = new ikibinyirmiucsecimikiBl(new EfikibinyirmiucsecimikiDal());
        Context c = new Context();
        public IActionResult Index()
        {
            ViewBag.hakkari = c.ikibinyirmiucsecimikis.Where(x => x.SehirID == 30).Select(y => y.SehirID).FirstOrDefault();
            ...
            ViewBag.tokat = c.ikibinyirmiucsecimikis.Where(x => x.SehirID == 60).Select(y => y.SehirID).FirstOrDefault();
